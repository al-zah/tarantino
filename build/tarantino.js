(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('tarantino', ['exports'], factory) :
	(factory((global.tarantino = global.tarantino || {})));
...
var listener = {
  ...
  init: function (fn, history) {
    ...
    if (!Router$$1.listeners) {
      Router$$1.listeners = [];
    }

    function onchange(onChangeEvent) {
      for (var i = 0, l = Router$$1.listeners.length; i < l; i++) {
        Router$$1.listeners[i](onChangeEvent);
      }
    }
    ...
    Router$$1.listeners.push(fn);

    return this.mode;
  },

  destroy: function (fn) {
    if (!Router$$1 || !Router$$1.listeners) {
      return;
    }

    var listeners = Router$$1.listeners;
...
function Router$$1(routes) {
  if (!(this instanceof Router$$1)) return new Router$$1(routes);

  // `Object.assign` is relatively new. Is there another easy way without introducing an extra dependency?
  Object.assign(this, Router$1.prototype);
...
Router$$1.prototype.init = function (r) {
  var self = this
    , routeTo;
...
Router$$1.prototype.explode = function () {
...
//
Router$$1.prototype.insertEx = function(method, path, route, parent) {
  if (method === "once") {
    method = "on";
...
Router$$1.prototype.getRoute = function (v) {
  var ret = v;
...
Router$$1.prototype.destroy = function () {
  listener.destroy(this.handler);
  return this;
};

Router$$1.prototype.getPath = function () {
